...
It's perfectly fine to re-use this definition in the rubrica application,
though.
...
from rubrica.model import DeclarativeBase, metadata, DBSession
...
class User(DeclarativeBase):
    ...
    created = Column(DateTime, default=datetime.now)
    contacts = relationship('Contatto')
